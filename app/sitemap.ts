...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ["", "/browse", "/search", "/glossary", "/tools", "/tools/tamil-letters", "/tools/letter-classifier", "/tools/matra-explorer", "/source", "/methodology", "/about", "/understanding", "/commentaries"];
